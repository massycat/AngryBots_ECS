...
{
    public class TurnSpeedConversion : MonoBehaviour, IConvertGameObjectToEntity
    {
        ...
        public void Convert(Entity entity, EntityManager dstManager, GameObjectConversionSystem conversionSystem)
        {
            ...
            RogueUtils.TurnSpeed turn_speed = new RogueUtils.TurnSpeed { Value = speed };
            dstManager.AddComponentData(entity, turn_speed);
        }
    }
}
